...
Contiene tanto las versiones finales de los códigos como los archivos GTFS y otros necesarios para el desarrollo.

## Orden de las carpetas
En "bueno" se encuentran los ficheros. Dentro aparecen en orden: "Program", "docs", "gps_2.0" y "gtfs".
